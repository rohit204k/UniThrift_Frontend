...
#         existing_passport = await core_service.read_one(Collections.PASSWORD, data_filter={'user_id': existing_user['_id']})
#     if not existing_passport:
...
#     if not recipient:
#         raise HTTPException(status.HTTP_404_NOT_FOUND, localization.EXCEPTION_EMAIL_NOT_REGISTERED)
